  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "We'll review your application and get back to you within 2-3 business days. Welcome to the Artistly family!",
      });
    ...
    <div className="space-y-8">
      <div>
        ...
        <Input
          ...
          className={`mt-3 border-2 rounded-xl text-lg p-4 ${
            errors.fullName
              ? "border-red-400"
      ...
      <div>
        ...
        <div className="mt-3 border-2 border-dashed border-primary/30 rounded-2xl p-8 text-center hover:border-primary/60 transition-colors bg-gradient-to-br from-primary/5 to-neon-50 dark:to-neon-950">
          {/* <Upload className="..." /> */}
          <div className="w-12 h-12 mx-auto mb-4 text-primary">⬆️</div>
          ...
          <Button
            variant="outline"
            size="lg"
            className="border-2 border-primary text-primary hover:bg-primary hover:text-white rounded-xl font-semibold"
          >
            Choose File
          </Button>
        </div>
  ...
  const renderStep2 = () => (
    <div className="space-y-8">
      ...
      <div>
        ...
        >
          <SelectTrigger
            className={`mt-3 border-2 rounded-xl text-lg p-4 h-14 ${
              errors.experience
                ? "border-red-400"
                : "border-primary/30 focus:border-primary"
            }`}
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center space-x-4 p-4 bg-gradient-to-r from-primary/10 to-neon-100 dark:to-neon-900 rounded-2xl border-2 border-primary/20">
        <Switch
          ...
          onCheckedChange={(checked) =>
            setFormData((prev) => ({ ...prev, availableForTravel: checked }))
          }
      ...
      <Alert className="border-2 border-sunshine-400 bg-gradient-to-r from-sunshine-50 to-coral-50 dark:from-sunshine-950 dark:to-coral-950 rounded-2xl">
        ...
        <AlertDescription className="text-lg text-sunshine-700 dark:text-sunshine-300 font-medium">
          Please review all information carefully before submitting. You'll be
          able to edit your profile after approval.
        </AlertDescription>
      </Alert>
    </div>
  );
          ...
          <CardHeader className="bg-gradient-to-r from-primary to-neon-500 text-white rounded-t-3xl p-8">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center space-x-2">
                <Badge
                  variant="secondary"
                  className="bg-white/20 text-white border-white/30 px-4 py-2 text-lg font-bold"
                >
